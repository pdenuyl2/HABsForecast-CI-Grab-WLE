...
arguments <- docopt(doc, args = c(" -l 41.8077 -L -83.3435 -d 2021-08-19 -t 14:00"))
#print(arguments)
...
#    )
#    # Optionally add sample metadata to result
#    result$lat <- lat
#    result$lon <- lon
#    result$date <- date
#    result$time <- time
...
#    input_list[[i]] <- result #previously results_list
#  }
